clear all;
close all;
Base  = '..\covid19_ECG\ECG Images of Patient that have abnormal heart beats (548)';
List  = dir(fullfile(Base, '**', '*.jpg'));
Files = fullfile({List.folder}, {List.name});
% load('coordinates.mat');
abnormal_statistical=[];
%iFile = 1


% figure, set(gcf,'visible','off');
for iFile = 1:250%numel(Files)
...
%         
    ...
    abnormal_statistical= [abnormal_statistical; comat_energy'];
